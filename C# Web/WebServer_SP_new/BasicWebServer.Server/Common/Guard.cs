...
namespace BasicWebServer.Server.Common
{
    ...
    {
        //When creating a software, which relies on user input, it is a good idea to add some checks of input
        //data. That’s why we will check every time when we create a class if there are any properties with
        //a NULL value, as they may be problematic.
