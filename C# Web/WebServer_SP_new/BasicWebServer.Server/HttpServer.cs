...
namespace BasicWebServer.Server
{
    public class HttpServer
    {
        ...
        public async Task Start()
        {
            ...
            //To make our server accept many requests, add a while loop to create and close a connection every time
            while (true)
            {
                ...
                _ = Task.Run(async () =>
                {
                    //to return a response from our server to the browser to visualize. To do this, first we need
                    //to create a stream, through which data is received or sent to the browser as a byte array
                    ...
                    //special method for writing the response in the network stream
        ...
        private async Task<string> ReadRequest(NetworkStream networkStream)
        {
            ...
            var totalBytes = 0;
            //will append the request strings and will be returned as a string to the method
            ...
            do
            {
                ...
                //to check the length of the request and stop the reading if it is too large
